...
STAGE_C_PT_4_INDEX_2_SIZE_2B_RES_720_FPS16_RECTIFIED_FLOW_WITH_EDM_CKPT = LazyDict(
    dict(
        ...
        model=dict(
            config=dict(
                # This is for cosmos-h-surgical-predict checkpoint, which is trained with conditional_frame_timestep=-1.0
                # and use_kerras_sigma_at_inference=False.
                # This will break the inference of using original cosmos-predict2.5 checkpoint.
