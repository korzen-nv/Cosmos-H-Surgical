...
# torchrun --nproc_per_node=1 --master_port=12341 -m scripts.train --config=cosmos_predict2/_src/predict2/configs/video2world/config.py -- experiment=predict2_video2world_training_2b_cosmos_h_surgical_assets
predict2_video2world_training_2b_cosmos_h_surgical_assets = dict(
    ...
    dataloader_train=dataloader_train_cosmos_h_surgical_assets,
    checkpoint=dict(
        save_iter=200,
...
for _item in [
    predict2_video2world_training_2b_cosmos_h_surgical_assets,
]:
