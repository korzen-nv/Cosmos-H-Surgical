...
cosmos_h_surgical_transfer_posttrain_edge_example = dict(
    defaults=[
    ...
    job=dict(
        ...
        name="cosmos_h_surgical_transfer_posttrain_edge_example",
    ),
    checkpoint=dict(
        save_iter=1000,
...
cosmos_h_surgical_transfer_posttrain_depth_example = dict(
    defaults=[
        DEFAULT_BASE_EXPERIMENT,
    ...
    job=dict(
        project="cosmos_h_surgical_transfer_posttrain",
        group="local_single_view",
        name="cosmos_h_surgical_transfer_posttrain_depth_example",
    ),
    checkpoint=dict(
        save_iter=1000,
...
cosmos_h_surgical_transfer_posttrain_seg_example = dict(
    defaults=[
        DEFAULT_BASE_EXPERIMENT,
    ...
    job=dict(
        project="cosmos_h_surgical_transfer_posttrain",
        group="local_single_view",
        name="cosmos_h_surgical_transfer_posttrain_seg_example",
    ),
    checkpoint=dict(
        save_iter=1000,
...
cosmos_h_surgical_transfer_posttrain_vis_example = dict(
    defaults=[
        DEFAULT_BASE_EXPERIMENT,
    ...
    job=dict(
        project="cosmos_h_surgical_transfer_posttrain",
        group="local_single_view",
        name="cosmos_h_surgical_transfer_posttrain_vis_example",
    ),
    checkpoint=dict(
        save_iter=1000,
...
for _item in [
    cosmos_h_surgical_transfer_posttrain_edge_example,
    cosmos_h_surgical_transfer_posttrain_depth_example,
    cosmos_h_surgical_transfer_posttrain_seg_example,
    cosmos_h_surgical_transfer_posttrain_vis_example,
]:
