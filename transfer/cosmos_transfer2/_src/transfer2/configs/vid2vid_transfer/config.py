...
from cosmos_transfer2._src.transfer2.configs.vid2vid_transfer.defaults.dataloader_local_json import (
    register_dataloader_local_json,
)
...
def make_config() -> Config:
    ...
    if not INTERNAL:
        ...
        register_dataloader_local_json()  # Register local dataloaders for post-training
    register_optimizer()
    register_scheduler()
    register_model()
    register_callbacks()
